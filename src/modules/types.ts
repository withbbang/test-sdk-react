export interface WelcomePaymentsInstance {
  pay(param: any, viewOpt?: any): any;
}

export interface WelcomePayments {
  init(param: any): WelcomePaymentsInstance;
  PAYMETHOD: any;
  MODE: any;
}
...
export interface TypeRadioInput {
  value: number | string;
  label: string;
  name: string;
}
